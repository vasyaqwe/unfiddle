...
<body style="font-family: 'San Francisco','Inter',sans-serif; font-size: 15px; margin: 0; padding: 20px;">
   ${
      preheader
   ...
   <table width="100%" role="presentation" style="max-width: 600px; margin: 0 auto; color: #333; line-height: 1.5;">
      <tr>
         <td>
            ${content}
            <p style="margin-top: 28px;">
               <a href="https://vasyaqwe.com" style="font-size: 14px; text-decoration: none; color: #141414;">
                  unfiddle by vasyaqwe
               </a>
            </p>
         </td>
      </tr>
