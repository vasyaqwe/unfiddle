...
INSERT INTO `__new_order_assignee`("creator_id", "workspace_id", "order_id", "created_at", "updated_at") SELECT "creator_id", "workspace_id", "order_id", "created_at", "updated_at" FROM `order_assignee`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_procurement`("id", "order_id", "creator_id", "workspace_id", "order_item_id", "quantity", "purchase_price", "status", "note", "provider", "created_at", "updated_at") SELECT "id", "order_id", "creator_id", "workspace_id", "order_item_id", "quantity", "purchase_price", "status", "note", "provider", "created_at", "updated_at" FROM `procurement`;--> statement-breakpoint
