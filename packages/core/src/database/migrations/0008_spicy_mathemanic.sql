...
CREATE TABLE `__new_order` (
	...
	`status` text,
	`vat` integer DEFAULT false NOT NULL,
	`client` text,
	`deleted_at` integer,
	`delivers_at` integer,
	`analogs` text DEFAULT '[]' NOT NULL,
...
INSERT INTO `__new_order`("id", "short_id", "creator_id", "workspace_id", "good_id", "group_id", "normalized_name", "name", "quantity", "selling_price", "desired_price", "severity", "note", "status", "vat", "client", "deleted_at", "delivers_at", "analogs", "created_at", "updated_at") SELECT "id", "short_id", "creator_id", "workspace_id", "good_id", "group_id", "normalized_name", "name", "quantity", "selling_price", "desired_price", "severity", "note", "status", "vat", "client", "deleted_at", "delivers_at", "analogs", "created_at", "updated_at" FROM `order`;--> statement-breakpoint
