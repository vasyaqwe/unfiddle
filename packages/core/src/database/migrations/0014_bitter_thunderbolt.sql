...
INSERT INTO `__new_procurement`("id", "order_id", "creator_id", "order_item_id", "quantity", "purchase_price", "status", "note", "provider", "created_at", "updated_at") SELECT "id", "order_id", "creator_id", "order_item_id", "quantity", "purchase_price", "status", "note", "provider", "created_at", "updated_at" FROM `procurement`;--> statement-breakpoint
