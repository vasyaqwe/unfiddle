...
export const CARD_STYLES = {
   base: "rounded-xl border flex flex-col relative before:absolute before:inset-0 has-[[data-card-header]]:before:bg-primary-2 before:rounded-xl before:z-[-1] isolate border-primary-12/12 bg-background p-4 shadow-md/4 has-[[data-card-header]]:border-none has-[[data-card-header]]:p-0",
   ...
   content:
      "p-4 xl:p-5 border grow border-primary-12/12 bg-background rounded-xl",
