...
export function TabsTab({
   ...
   return (
      <TabsPrimitive.Tab
         className={cn(
            "inline-flex h-9 cursor-pointer items-center justify-center rounded-md px-3 font-[450] text-foreground/75 hover:bg-primary-3 hover:text-foreground aria-selected:text-foreground md:h-7 md:px-2 md:text-sm",
